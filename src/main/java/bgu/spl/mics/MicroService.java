...
public abstract class MicroService implements Runnable {
  ...
  //  private PriorityQueue<Callback> arrivedEventCallbacks;
    //protected PriorityQueue<Event> arrivedMessages;
    ...
    public MicroService(String name) {
        this.name = name;
        //arrivedMessages=new PriorityQueue<>();
        callbacks = new ConcurrentHashMap<>();
        //arrivedEventCallbacks=new PriorityQueue<>();
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                currMessage=MessageBusImpl.getInstance().awaitMessage(this);
