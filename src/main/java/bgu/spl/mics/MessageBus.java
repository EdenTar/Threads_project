...
public interface MessageBus {
     ...
     * @pre  m!=null & type!=null & isSubscribeEvent(type,m)==false
     * @inv m.isMicroServiceRegistred(m)==true
     * @post isSubscribeEvent(type,m)==true
     */
    <T> void subscribeEvent(Class<? extends Event<T>> type, MicroService m);
    /**
     * check if the current event has subscribes
     * @param <T>  The type of the result expected by the completed event.
     * @param type The type to subscribe to,
     * @param m    The subscribing micro-service.
    ...
    <T> boolean isSendEvent(Event<T> e);
     ...
     * @param type 	The type to subscribe to.
     * @param m    	The subscribing micro-service.
     * @pre broadcast.Subscribers.Contains(m)==false & type!=null & m!=null
     * @inv m.isMicroServiceRegistred(m)==true
     * @post broadcast.Subscribers.Contains(m)==true
     */
     ...
     * @pre microService finish the event
     * @post e.result=result
     */
     ...
     *@pre b!=null & b.subscribers.IsEmpty()==false
     *@inv
     *@post IsBroadcastSent==true
     */
     ...
     *@post
     */
    boolean IsBroadcastSent(Broadcast b);
    /**
     ...
     * @pre m.isSend(e)==false
     * @inv event e is already subscribed
     * @post m.isSend(e)==true
     */
     ...
     *@pre m!=null
     *@inv
     *@post MicroServices.containsKey(m)==true
     */
     ...
     * @pre MicroServices.containsKey(m)==true
     * @post MicroServices.containsKey(m)==false
     */
     ...
     *          queue.
     *@pre messageBus.isMicroServiceRegistred(m)==true
     *@inv MicroServices.get(m).IsEmpty()==false & isMicroServiceRegistred(m)==true
     *@post MicroServices.get(m).size()=@pre(MicroServices).size()-1
     *@return The next message in the {@code m}'s queue (blocking).
     *@throws InterruptedException if interrupted while waiting for a message
     *                              to became available.
     */
    Message awaitMessage(MicroService m) throws InterruptedException;
    boolean isServiceQueueEmpty(MicroService m);
